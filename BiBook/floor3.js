...
floor3.addEventListener("submit", (e) => {
    e.preventDefault()

    let roomfloor = document.getElementsByName("roomfloor3")
    ...
    if(!roomfloor[0].checked && ! roomfloor[1].checked && ! roomfloor[2].checked
        ...
        && ! roomfloor[9].checked  && ! roomfloor[10].checked && ! roomfloor[11].checked
        && ! roomfloor[12].checked){
